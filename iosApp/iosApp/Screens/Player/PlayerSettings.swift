...
final class PlayerSettings {
    ...
    /// and mean different bitrates by it (10 Mbps in ``PrairieQualityPresets``,
    ...
    var currentQualityPreset: PrairieQualityPreset? {
        PrairieQualityPresets.preset(
            resolution: preferredQualityResolution,
            bitrateKbps: maxBitrateKbps
        )
    }
    ...
    var preferredQualityLabel: String {
        PrairieQualityPresets.describe(
            resolution: preferredQualityResolution,
            bitrateKbps: maxBitrateKbps
        )
    }
    ...
    /// constructing a Prairie source cache.
    ...
    func setQualityPreset(_ preset: PrairieQualityPreset) {
    ...
    private func setQualityAxes(resolution: String, bitrateKbps: Int?) {
        preferredQualityResolution = PrairieQualityPresets.normalizeResolution(resolution)
    ...
    private func applyEffectiveSettings(_ effectiveByKey: [SettingKey: EffectiveSettingValue]) {
        ...
        preferredQualityResolution = PrairieQualityPresets.normalizeResolution(
    ...
    /// ``PrairieQualityPresets/normalizeResolution(_:)`` reduces both to a
    ...
    private static func cachedQualityResolution(_ defaults: UserDefaults) -> String {
        PrairieQualityPresets.normalizeResolution(
