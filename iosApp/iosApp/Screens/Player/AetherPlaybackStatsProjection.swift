...
/// Immutable Prairie-owned context that Aether cannot infer from a media source.
...
/// Value-only snapshot of the public Aether state used by Prairie diagnostics.
