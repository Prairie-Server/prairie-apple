...
extension ContinuumAPI {
    ...
    ///
    /// `mutationId` (sent as `X-Prairie-Mutation-Id`) makes retries safe: create
    ...
    func putValue(
        ...
        headers["X-Prairie-Mutation-Id"] = trimmedMutationId
        ...
        do {
            ...
            return SettingValueWriteReceipt(
                value: stored,
                isIdempotentReplay: response.header("X-Prairie-Idempotent-Replay") == "true"
            )
        } catch {
