...
/// Length-prefixed framing for Prairie's LAN channels (companion pairing,
/// PrairieControl): each payload is sent as a 4-byte big-endian unsigned length
...
struct PrairieFrameBuffer {
    ...
    mutating func append(_ data: Data) throws -> [Data] {
        ...
        while true {
            ...
            guard length <= PrairieFrame.maxFrameBytes else {
                throw PrairieFrame.FrameError.frameTooLarge(length)
            }
