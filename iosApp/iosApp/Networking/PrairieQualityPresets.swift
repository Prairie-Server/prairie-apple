//
//  PrairieQualityPresets.swift
//  Prairie (iOS + tvOS + macOS)
//
//  The quality picker's presets, as every Prairie client offers them.
//
...
struct PrairieQualityPreset: Identifiable, Hashable {
    let id: String
    let label: String
...
enum PrairieQualityPresets {
    ...
    static let all: [PrairieQualityPreset] = [
        .init(
            id: "auto",
            label: "Auto",
            description: "Prairie picks based on your connection.",
    ...
    static func preset(resolution: String?, bitrateKbps: Int?) -> PrairieQualityPreset? {
    ...
    static func preset(id: String?) -> PrairieQualityPreset? {
