...
extension DiagnosticsBinding {
    ...
    static func hosted(serverRegistryID: String, accountUserID: String) -> DiagnosticsBinding {
        ...
        // evidence, and retries to the Prairie server/account that captured them.
        ...
        // evidence from crossing Prairie accounts. Persist a domain-separated
