...
/// when the app owns the session outright — Prairie runs two engines (audiobooks and
...
/// leaving whatever Prairie interrupted (another app's audio) paused or ducked until
/// Prairie is killed. A claim therefore carries an *activity probe*, and the release
