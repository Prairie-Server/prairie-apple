...
enum ProfileLaunchBehavior: String, Codable, CaseIterable, Identifiable, Sendable {
    ...
    /// How long Prairie can be away before Who's Watching is shown again.
    ...
    var standardDescription: String {
        ...
        case .askEveryLaunch:
            return "Show Who's Watching whenever you return to Prairie."
        case .afterOneHour:
            return "Show Who's Watching when you've been away from Prairie for 1 hour."
        case .afterTwelveHours:
            return "Show Who's Watching when you've been away from Prairie for 12 hours."
        }
    }
