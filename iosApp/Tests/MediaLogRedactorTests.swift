...
final class MediaLogRedactorTests: XCTestCase {
    ...
    private static let auditedSamples: [String] = [
        ...
        #"headers=["X-Profile-Token": "profile-secret", "X-Prairie-Auth": "auth-secret"] frames=42"#,
    ...
    func testRedactsCustomCredentialHeadersWithoutDroppingLaterTelemetry() {
        let source = #"headers=["X-Profile-Token": "profile-secret", "X-Prairie-Auth": "auth-secret", "X_Profile_Token": "underscore-secret"] frames=42 rate=1.000"#
        let redacted = MediaLogRedactor.sanitize(source)
    ...
    func testRedactsCachesAndTildeHomePaths() {
        ...
        let home = MediaLogRedactor.sanitize("cache ~/Documents/Prairie/Show Name S02E03.mkv loaded")
