...
final class EarlyBootBufferTests: XCTestCase {
    ...
    func testPreConsentLaunchBreadcrumbsDoNotPurgeThePreviousRunJournal() throws {
        ...
        // `PrairieApp.init` → `LaunchTimeline.recordProcessStart()`. Refused,
    ...
    func testStagedLinesSurviveARestoredSessionLaunchAndReachTheJournal() {
        ...
        // `PrairieApp.init` onward: staged, because no account is established yet.
    ...
    /// `PrairieApp.init`: no live consent context, profile eligibility unresolved,
