...
The unsigned lanes additionally set `PRAIRIE_BUILD_CHANNEL=sideload`, which the
app reports to the server as `X-Prairie-Client-Channel`. That is what separates a
