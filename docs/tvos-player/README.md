...
Current architecture as of 2026-08-23: Prairie's library-media implementation is
...
- [`AetherLoadSpec.swift`](../../iosApp/iosApp/Screens/Player/AetherLoadSpec.swift)
  maps Prairie online/offline plans into Aether load inputs.
...
- [`PlayerViewModel.swift`](../../iosApp/iosApp/Screens/Player/PlayerViewModel.swift)
  retains Prairie product/session behavior while delegating media execution to
  AetherEngine.
