...
This file describes third-party code shipped by the installable Prairie Apple
...
`iosApp/Prairie.xcodeproj/project.xcworkspace/xcshareddata/swiftpm/Package.resolved`.
...
product. `AetherEngineSMB` and SMBClient are not linked or copied into Prairie's
